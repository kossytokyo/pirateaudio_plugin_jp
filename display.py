...
FONT_DICT = {
    "FONT_S": ImageFont.truetype(''.join([SCRIPT_PATH, '/fonts/NotoSansJP-Medium.otf']), 20),
    "FONT_M": ImageFont.truetype(''.join([SCRIPT_PATH, '/fonts/NotoSansJP-Medium.otf']), 24),
    "FONT_L": ImageFont.truetype(''.join([SCRIPT_PATH, '/fonts/NotoSansJP-Medium.otf']), 30),
